...
( function( global, factory ) {
	...
	if ( typeof module === "object" && typeof module.exports === "object" ) {
		...
		// esto es para entornos CommonJS y similares a CommonJS en los que una "ventana" adecuada
		// está presente, ejecute la fábrica y obtenga jQuery.
		// y para entornos que no tienen una 'ventana' con un 'documento'
		// (como Node.js), exponemos una fábrica como module.exports.
...
// estos intentos estén protegidos en un bloque de ensayo.
"use strict";
...
var isFunction = function isFunction( obj ) {
	  ...
	  //En algunos navegadores, typeof devuelve "function" para <object> los elementos HTML
...
var
	...
	jQuery = function( selector, context ) {
		...
		// Necesita init si se llama a jQuery (solo permita que se lance un error si no se incluye)
		return new jQuery.fn.init( selector, context );
	},

	// Soporte: solo Android <=4.0
	// Asegúrese de que recortamos la lista de materiales y el NBSP
	rtrim = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
...
jQuery.fn = jQuery.prototype = {
	...
	get: function( num ) {
		...
		// Devuelve todos los elementos de una matriz limpia
		if ( num == null ) {
			return slice.call( this );
		}
	...
	// Tome una serie de elementos y empújelos en la pila
	// (devolviendo el nuevo conjunto de elementos coincidentes)
	pushStack: function( elems ) {

		// Creación de un nuevo conjunto de elementos coincidentes de jQuery
		var ret = jQuery.merge( this.constructor(), elems );

		// Agregue el objeto antiguo a la pila (como referencia)
		ret.prevObject = this;
	...
	// Ejecute una devolución de llamada para cada elemento del conjunto coincidente.
...
jQuery.extend = jQuery.fn.extend = function() {
	...
	// Controlar mayúsculas y minúsculas cuando el destino es una cadena o algo
	if ( typeof target !== "object" && !isFunction( target ) ) {
		target = {};
	}

	// Amplíe jQuery si solo se pasa un argumento
	if ( i === length ) {
		target = this;
		i--;
	}
	...
	for ( ; i < length; i++ ) {
		...
		// Tratar solo con valores no nulos o indefinidos
...
jQuery.extend( {
	...
	// Supongamos que jQuery está listo sin el módulo ready
	isReady: true,
	...
	isPlainObject: function( obj ) {
		...
		// Detectar aspectos negativos obvios
	...
	// results es solo para uso interno
	...
	// Soporte: solo para Android <=4.0, solo PhantomJS 1
	// push.apply(_, arraylike) arroja en el antiguo WebKit
	...
	grep: function( elems, callback, invert ) {
		...
		// Revisa la matriz, guardando solo los elementos
	...
	map: function( elems, callback, arg ) {
		...
		// Recorra la matriz, traduciendo cada uno de los elementos a sus nuevos valores
...
var i,
	...
	pseudos = ":(" + identifier + ")(?:\\((" +
		// Para reducir el número de selectores que necesitan tokenización en el preFilter, prefiera los argumentos:
		// 1. Cotizado (captura 3; captura 4 o captura 5)
		"('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|" +
		// 2. Simple (captura 6)
		"((?:\\\\.|[^\\\\()[\\]]|" + attributes + ")*)|" +
	...
	matchExpr = {
		...
		// Para su uso en bibliotecas que implementan .is()
		// Usamos esto para la coincidencia de POS en 'seleccionar'
	...
	funescape = function( _, escaped, escapedWhitespace ) {
		...
		// NaN significa que no es un punto de código
		//Soporte: Firefox<24
		//Solución alternativa a la interpretación numérica errónea de +"0x"
		return high !== high || escapedWhitespace ?
			escaped :
			high < 0 ?
				// BMP codepoint
				String.fromCharCode( high + 0x10000 ) :
				// Punto de código de plano suplementario (par suplente)
